...
import LanguageInternationalExperience from "@/components/blog/LanguageInternationalExperience";
...
const aboutMePage = () => {
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-white rounded-lg shadow-md p-6 border border-base-200">
          ...
          <p className="mb-6 text-gray-700">
            질문이나 협업 제안, 또는 그냥 인사를 나누고 싶으시다면 언제든지 연락주세요.
            이메일이나 소셜 미디어를 통해 소통할 수 있습니다.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a 
                  href="mailto:qkrtk9230@gmail.com" 
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a 
                  href="https://www.linkedin.com/in/guencheol-park-a9b3a623b/" 
                  target="_blank" 
      ...
      <LanguageInternationalExperience />
    </div>
  );
};
